...
const StockInForm = ({ onStockIn }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.StockInQuantity || formData.StockInQuantity <= 0) {
    ...
    try {
      const res = await api.post("/api/stock-in", formData, {
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  StockInQuantity: parseInt(e.target.value) || 0,
                })
              }
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
            />
